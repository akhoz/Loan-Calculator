...
import { moneyFormat, calculateTotalToPay} from "./helpers";

function App() {
    const [amount, setAmount] = useState(5000);
    const [term, setTerm] = useState(6);
    const [total, setTotal] = useState(calculateTotalToPay(amount, term));

    useEffect(() => {
        setTotal(calculateTotalToPay(amount, term));
    }, [amount, term]);
    ...
    return (
        ...
        <div className="my-20 max-w-lg mx-auto bg-white shadow p-10">
            ...
            <input type="range"
                   className="w-full h-6 bg-gray-200 accent-indigo-600"
            ...
            <div className="my-5 space-y-3 bg-gray-50 p-5">
                ...
                <p className="text-xl text-gray-500 text-center font-bold">{moneyFormat(total)} Total amount</p>
